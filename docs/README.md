...
* [Creating a new service](development/creating-a-new-service.md)
* [Development environment](development/dev-environment.md)
* [Setting up Azurite Storage Emulator](development/setting-up-azurite.md)
...
* [Setting up Azure environment](azure/README.md)
