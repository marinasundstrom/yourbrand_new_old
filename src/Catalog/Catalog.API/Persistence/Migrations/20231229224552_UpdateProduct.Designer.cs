            ...
            modelBuilder.Entity("Catalog.API.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Catalog.API.Domain.Entities.Store", "Store")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Catalog.API.Domain.Entities.Store", b =>
                {
                    ...
                    b.OwnsOne("Catalog.API.Domain.Entities.CurrencyDisplayOptions", "CurrencyDisplayOptions", b1 =>
                        {
                    ...
                    b.OwnsOne("Catalog.API.Domain.Entities.PricingOptions", "PricingOptions", b1 =>
                        {
                            b1.Property<string>("StoreId")
                                .HasColumnType("nvarchar(450)");
