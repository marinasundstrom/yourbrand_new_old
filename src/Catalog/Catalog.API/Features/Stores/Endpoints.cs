...
using YourBrand.Catalog.API.Features.Stores.Commands;
using YourBrand.Catalog.API.Features.Stores.Queries;
...
public static class Endpoints
{
    ...
    public static async Task<PagedResult<StoreDto>> GetStores(int page = 1, int pageSize = 10, string? searchString = null, string? sortBy = null, API.SortDirection? sortDirection = null, IMediator mediator = default, CancellationToken cancellationToken = default)
    {
