...
public static class Endpoints 
{
    ...
    {
        var result = await mediator.Send(new AddCartItem(id, cartItemRequest.Name, cartItemRequest.ProductId, cartItemRequest.Description, cartItemRequest.Price, cartItemRequest.RegularPrice, cartItemRequest.Quantity), cancellationToken);
